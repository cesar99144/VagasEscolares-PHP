...
<html>
    ...
    <body>
        ...
        <nav class="nav nav-pills nav-fill container bg-dark d-flex justify-content-center">
            <a class="nav-item nav-link text-light" href="<?php echo URL_BASE; ?>">Vagas</a>
            <a class="nav-item nav-link text-light" href="<?php echo URL_BASE; ?>">Matriculas aprovadas</a>
            <a class="nav-item nav-link text-light" href="<?php echo URL_BASE; ?>">Solicitações</a>
        </nav>
